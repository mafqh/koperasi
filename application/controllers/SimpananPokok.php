...
class SimpananPokok extends Admin_Controller {
    ...
    public function simpanan()
    {
        if($this->data['is_can_read']){
            ...
            $this->data['title'] = "Simpanan Pokok";
            $this->data['jenis'] = $this->koperasiModel->get_data_biaya_administrasi($anggota)->result();
            $this->load->view('templates_admin/header', $this->data);
            $this->load->view('templates_admin/sidebar', $this->data);
            $this->load->view('admin/SimpananPokok', $this->data);
    ...
    public function tambahSimpananPokok()
    {
        if($this->data['is_can_create']){
            $this->data['title'] = "Tambah Simpanan Pokok";
            $this->load->view('templates_admin/header', $this->data);
            $this->load->view('templates_admin/sidebar', $this->data);
            $this->load->view('admin/formTambahSimpananPokok', $this->data);
            $this->load->view('templates_admin/footer');
        }else{
            show_404();
        }
    ...
    public function Tambah() 
    {
        if($this->data['is_can_create']){
            ...
            redirect('SimpananPokok/simpanan/' .$jenis);
        }else{
            show_404();
        }
    }
    ...
    public function detailSimpananPokok()
    {
        if($this->data['is_can_read']){
            ...
            $this->data['title'] = "Detail Simpanan Pokok";
            $this->data['anggota'] = $this->koperasiModel->get_data_administrasi_by_anggota($anggota)->result();
            $this->load->view('templates_admin/header', $this->data);
            $this->load->view('templates_admin/sidebar', $this->data);
            $this->load->view('admin/formDetailSimpananPokok', $this->data);
            $this->load->view('templates_admin/footer');
        }else{
            show_404();
        }  
    ...
    public function editSimpananPokok() 
    {
        if($this->data['is_can_edit']){
            ...
            $this->data['simpanan'] = $this->koperasiModel->getDataSimpanan($id_simpanan);
            $this->data['title'] = "Edit Simpanan Pokok";
            $this->load->view('templates_admin/header', $this->data);
            $this->load->view('templates_admin/sidebar', $this->data);
            $this->load->view('admin/formEditSimpananPokok', $this->data);
            $this->load->view('templates_admin/footer');
        }else{
            show_404();
        }
    ...
    public function update()
    {
        if($this->data['is_can_edit']){
            ...
            redirect('SimpananPokok/detailSimpananPokok/'.$id_anggota);
        }else{
            show_404();
        }
    }
