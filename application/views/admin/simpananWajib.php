<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <?php if( $this->session->userdata('hak_akses') == 1){ ?>
            <a href="<?php echo base_url('admin/simpananWajib/exportExcel'); ?>" class="btn btn-success shadow-sm" id="btn-export-excel"><i class="fas fa-file-excel fa-sm text-white-50"></i> Export Excel</a>
        <?php } ?>
    </div>
