 ...
 */
$config['site_title']                 = "dlh.sukabumikota.go.id";       // Site Title, example.com
$config['admin_email']                = "dlh@sukabumikota.go.id"; // Admin Email, admin@example.com
...
$config['email_config'] = array(
    ...
    'smtp_port' => 465,
    'smtp_user' => 'simanis@shirobyte.com', // Ganti dengan email gmail Anda
    'smtp_pass' => 'p0h0d3u1??', // Password gmail Anda
    'smtp_keepalive' => TRUE,
    'smtp_crypto' => 'SSL',
    'wordwrap'  => TRUE,
    'wrapchars' => 80,
